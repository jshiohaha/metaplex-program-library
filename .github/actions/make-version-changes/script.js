...
const updateCratesPackage = async (io, cwdArgs, pkg, semvar) => {
  ...
  console.log('==================================');
  console.log('git status before update');
  ...
  // if we globally installed `@iarna/toml`, that will have been committed along with `cargo release` command. so, we need to resolve this.
  wrappedExec(`git restore --source=HEAD^ --staged -- ${rootDir.join('/')} && git commit --amend --allow-empty -C HEAD`);

  // /Users/jacobshiohira/projects/crypto/solana/metaplex/metaplex-program-library/candy-machine/program/src/lib.rs
  ...
  console.log('==================================');
  console.log('git status after update');
  wrappedExec(`git status`);
  console.log('==================================');
  ...
  console.log('==================================');
  console.log('post idl change git status output');
  wrappedExec(`git status`);
  console.log('==================================');
